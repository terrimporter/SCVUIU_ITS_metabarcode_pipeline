#!/usr/bin/perl
#November 21, 2018 by Terri Porter
#Script to add read abundance from cat.fasta.table to cat.denoised.out
#USAGE perl add_abundance_to_rdp_out4.plx cat.fasta.table cat.denoised.out
