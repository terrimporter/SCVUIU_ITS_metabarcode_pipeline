...
# Skips superkingdom rank for ESVs classified using the RDP classifier with the UNITE reference set
...
print STDOUT "GlobalESV,SampleName,ESVsize,Strand,Root,RootRank,rBP,Kingdom,KingdomRank,kBP,Phylum,PhylumRank,pBP,Class,ClassRank,cBP,Order,OrderRank,oBP,Family,FamilyRank,fBP,Genus,GenusRank,gBP,Species,SpeciesRank,sBP\n";
